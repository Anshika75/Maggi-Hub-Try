...
export default function SubMenuCard(props) {
  ...
  return (
    <>
      ...
      {
        isOpen ? (
          <div className="absolute z-20 h-[250px] w-[500px] bg-[#FFFFFF] shadow-[0_0_4px_1px_#e3e3e37c] flex flex-row justify-center items-center ">
            ...
            <div className="w-[60%] h-full flex flex-col justify-start items-start">
              ...
              <div className="text-lg text-grey font-Dosis mt-5 mx-3 font-light opacity-75">{props.desc}</div>
            </div>
