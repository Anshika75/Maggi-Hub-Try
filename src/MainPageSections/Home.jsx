  ...
  return (
    <>
        <div className="flex flex-col items-center justify-center h-[75vh] w-full bg-cover text-white" style={bg}>
            ...
            <div className="text-[30px] lg:text-[40px] font-Pacifico opacity-80">Welcome to</div>
            <div className="text-[60px] lg:text-[80px] relative -mt-7 text-yellow font-Null tracking-normal first-letter:mr-1 opacity-90" style={shadow}>MaggiHub
            <div className="flex flex-row items-center justify-center text-xs lg:text-base absolute bottom-0 translate-y-[50%] w-full text-white opacity-70" style={noShadow}>★★★★★★★★★★★★★★★★★★★★</div>
            </div>
            <div className="lg:text-xl text-base font-Pacifico mt-3 opacity-75 mb-7">Delight in every bite</div>
